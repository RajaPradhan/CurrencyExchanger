...
import { LiveRateState, LiveRateDispatch, LiveRateActionType } from '../types';
...
const useLiveRateContext = () => {
  ...
  if (context === undefined) {
    throw new Error(
      'useLiveRateContext must be used within a ExchangeProvider',
    );
  }
  return context;
};
...
const useLiveRateDispatch = () => {
  ...
  if (context === undefined) {
    throw new Error(
      'useLiveRateDispatch must be used within a ExchangeProvider',
    );
  }
  return context;
};
